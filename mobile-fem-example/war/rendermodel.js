 ...
 * 
 * Captures the video signal and compares single frames to detect motion. The
 * center of this motion is used to find the viewpoint of the user. With this
 * viewpoint the camera position will be rotated.
 * 
 */
